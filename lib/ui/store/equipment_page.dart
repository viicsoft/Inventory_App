                                        ...
                                        children: [
                                          Container(
                                            ...
                                            decoration: BoxDecoration(
                                              ...
                                              image: DecorationImage(
                                                image: NetworkImage(results[index].equipmentImage),
                                                fit: BoxFit.cover,
                                              ),
                                            ),
                                          ),
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            SizedBox(
                                              ...
                                              child: Column(
                                                crossAxisAlignment:
                                                    CrossAxisAlignment.start,
                                                children: [
                                                  Text(results[index].equipmentName,
                                                    maxLines: 2,
                                                    style: TextStyle(
                                                        color:
                                                    ...
                                                    children: [
                                                      Container(
                                                        decoration: BoxDecoration(
                                                          ...
                                                          color:  colorscondition(results[index].equipmentCondition)
                                                        ),
                                                        padding:
                                                            const EdgeInsets.all(5),
                                                        height: 18,
                                                        child: Text(results[index].equipmentCondition,
                                                          style: TextStyle(
                                                              fontWeight:
                                                                  FontWeight.bold,
                                                              fontSize: 8,
                                                      ...
                                                      TextButton(
                                                        ...
                                                        onPressed: () {
                                                          Navigator.push(
                                                            context,
                                                            MaterialPageRoute(
                                                              builder: (context) => EquipmentDetailPage(equipmentElement: results[index], equipmentId: results[index].id),
                                            ...
                                            SizedBox(
                                              width:
                                                  MediaQuery.of(context).size.width,
                                              child: Text(results[index].equipmentDescription!.isEmpty ? 'No description' : results[index].equipmentDescription!,
                                                maxLines: 2,
