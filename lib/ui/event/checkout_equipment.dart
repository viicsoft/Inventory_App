...
class _CheckOutEquipmentPageState extends State<CheckOutEquipmentPage> {
  ...
  late Future<List<EquipmentCheckout>> _equipmentCheckOut;
  ...
  void initState() {
    ...
    _equipmentCheckOut = _equipmentCheckOutAPI.fetchAllEquipmentCheckOut();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<List<EquipmentCheckout>>(
          future: _equipmentCheckOut,
          builder: (context, snapshot) {
            ...
            if (snapshot.connectionState == ConnectionState.done) {
              ...
              final equipmentCheckout = snapshot.data!;
                  return Container(
